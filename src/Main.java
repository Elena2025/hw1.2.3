public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Разницу между весами бойцов: " + (boxer2Weight - boxer1Weight));

        // Задача 7
        System.out.println("Задача 7");
        System.out.println("Разницу между весами бойцов(1 способ): " + (boxer2Weight - boxer1Weight));
        System.out.println("Разницу между весами бойцов(2 способ): " + (boxer2Weight % boxer1Weight));
